...
public class UIScrollView : MonoBehaviour
{
    ...
    public delegate void OnDragProgess(float horizontal, float vertical);
    ...
    public OnDragProgess onDragProgess;
	...
	public virtual void UpdateScrollbars (bool recalculateBounds)
	{
		...
		if (onDragProgess != null || horizontalScrollBar != null || verticalScrollBar != null)
		{
			...
			Vector2 bmin = b.min;
			Vector2 bmax = b.max;
            Vector2 barProgess = Vector2.zero;
            if ((horizontalScrollBar != null || onDragProgess != null) && bmax.x > bmin.x)
			{
				Vector4 clip = mPanel.finalClipRegion;
                ...
                barProgess.x = MathScrollbars(contentMin, contentMax, contentSize, viewSize, false);
                if (horizontalScrollBar != null)
				UpdateScrollbars(horizontalScrollBar, contentMin, contentMax, contentSize, viewSize, false);
			}

			if ((verticalScrollBar != null || onDragProgess != null) && bmax.y > bmin.y)
			{
				Vector4 clip = mPanel.finalClipRegion;
                ...
                barProgess.y = MathScrollbars(contentMin, contentMax, contentSize, viewSize, true);
                if (verticalScrollBar != null)
				    UpdateScrollbars(verticalScrollBar, contentMin, contentMax, contentSize, viewSize, true);
			}
            if (onDragProgess != null) onDragProgess(barProgess.x, barProgess.y);
		}
    ...
    protected float MathScrollbars(float contentMin, float contentMax, float contentSize, float viewSize, bool inverted)
    {
        float contentPadding;
        ...
        if (viewSize < contentSize)
        {
            ...
            contentPadding = contentMin + contentMax;
            return inverted ? ((contentPadding > 0.001f) ? 1f - contentMin / contentPadding : 0f) :
                ((contentPadding > 0.001f) ? contentMin / contentPadding : 1f);
        }
        else
        {
